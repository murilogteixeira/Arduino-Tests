...
const char* ssid = "Murilo"; /* coloque aqui o nome da rede wi-fi que o ESP32 deve se conectar */
const char* password = "94658243"; /* coloque aqui a senha da rede wi-fi que o ESP32 deve se conectar */
